...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        int maxDefLvl = MAX_HIT_POINTS - attackLevel;

        System.out.print("Enter your defense level (1-" + maxDefLvl + "): ");
        int defenseLevel = myScan.nextInt();

        while (defenseLevel < 1 || defenseLevel > maxDefLvl) {
            System.out.print("Sorry. The defense level must be between 1 and " + maxDefLvl + ": ");
    ...
    public static void printWhoIsAhead() {
        if (firstPokemon.hitPoints > secondPokemon.hitPoints) {
            ...
            System.out.println("Nobody is currently ahead!");
        }
    }
    ...
    public static void determineWinner() {
        if (firstPokemon.hitPoints < 1 && secondPokemon.hitPoints > 0) {
            System.out.println(firstPokemon.name + " is the winner!");
        } else if (secondPokemon.hitPoints < 1 && firstPokemon.hitPoints > 0) {
